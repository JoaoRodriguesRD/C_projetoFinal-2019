...
//Recebe o bolao
//Retorna nada
void bolao_finalizar(tbolao bolao[0])
{
	char opcao_tipo;
...
//
//Retorna nada
void bolao_ganhador(tbolao bolao[0], tapostadores apost[MAX_APOSTADORES])
{
...
//		bolao[0].bolaoU.numeros
//		bolao[0].bolaoU.quant_numeros
		for(i = 0; i < 6; i++)
		{
	...
	else
	{
		...
		//	bolao[0].bolaoV.quant_cartoes;
		//	bolao[0].bolaoV.numeros[MAX_CARTOES][MAX_NUMEROS]
		//	bolao[0].bolaoV.
...
// Retorna nada
void menu_apostas(tapostadores apost[MAX_APOSTADORES], tbolao bolao[0])
{
	int opcao;
	/*
	1- Novo
